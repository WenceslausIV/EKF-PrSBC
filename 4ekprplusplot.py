...
def pos_compare():
    ...
    for i in range(100):
        ...
        ax.scatter(pp_list[i][0,0], pp_list[i][1,0], color='black', marker='o')
        ax.scatter(gt_list[i][0,0], gt_list[i][1,0], color='red', marker='x')
        ax.scatter(np_list[i][0,0], np_list[i][1,0], color= 'green', marker='*')
