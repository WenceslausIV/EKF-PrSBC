...
def create_single_integrator_barrier_certificate(barrier_gain=100, safety_radius=0.2, magnitude_limit=0.2):
...
def create_unicycle_barrier_certificate(barrier_gain=100, safety_radius=0.2, projection_distance=0.05, magnitude_limit=0.2):
...
unicycle_barrier_cert =  create_unicycle_barrier_certificate(safety_radius = 0.2)
...
def control_callback(event):
    ...
    dxu = unicycle_position_controller(x, goal_points) / 20
